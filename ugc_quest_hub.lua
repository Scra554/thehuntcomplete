...
SpeedBox.Position = UDim2.new(0, 120, 0, 40)
...
SpeedButton.Size = UDim2.new(0, 50, 0, 25)
SpeedButton.Position = UDim2.new(0, 190, 0, 40)
...
JumpBox.Position = UDim2.new(0, 120, 0, 75)
...
JumpButton.Size = UDim2.new(0, 50, 0, 25)
JumpButton.Position = UDim2.new(0, 190, 0, 75)
...
FlingButton.Size = UDim2.new(0, 230, 0, 35)
FlingButton.Position = UDim2.new(0, 10, 0, 110)
...
-- Target Box for Fling
local TargetBox = Instance.new("TextBox")
TargetBox.Size = UDim2.new(0, 230, 0, 25)
TargetBox.Position = UDim2.new(0, 10, 0, 155)
TargetBox.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
TargetBox.PlaceholderText = "Target Player Name (or 'all')"
...
local function FlingPlayer(target)
    ...
    bodyVelocity.Velocity = (targetRoot.Position - RootPart.Position).Unit * Settings.FlingPower + Vector3.new(0, 500, 0)
...
FlingButton.MouseButton1Click:Connect(function()
    ...
    if Settings.FlingEnabled then
        FlingButton.BackgroundColor3 = Color3.fromRGB(50, 255, 50)
        FlingButton.Text = "FLING: ON (Click to fling)"
